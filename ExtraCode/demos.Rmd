...
spAnoB=maskedRangeR(potentialDist=spA,
                    maskLayers=spB,
...
logicString='maskLayers>0.5'
spAnoB.t=maskedRangeR(potentialDist=spA.t,maskLayers=spB.t,logicString,method='mask')
...
spAnoB.t2=maskedRangeR(potentialDist=spA.t,maskLayers=spB.t,logicString,method='mask')
