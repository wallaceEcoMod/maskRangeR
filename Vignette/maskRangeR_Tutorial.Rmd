...
dateScale <- "year" # or "month", "day"
envDates <- parse_date_time((c('2005','2006','2008','2009','2010')),orders = c("Y", "Ym"))
env <- readRDS(paste0(getwd(), "/maskRangeR/inst/extdata/env.RDS"))
datedOccs <- readRDS(paste0(getwd(), "/maskRangeR/inst/extdata/datedOccs.RDS"))
sdm <- readRDS(paste0(getwd(), "/maskRangeR/inst/extdata/sdm.RDS"))
```
...
```{r, include = F}
original <- readRDS(paste0(getwd(), "/maskRangeR/inst/extdata/original.RDS"))
expertAddedPoly <- readRDS(paste0(getwd(), "/maskRangeR/inst/extdata/expertAddedPoly.RDS"))
```
...
```{r, include=F}
expertMap <- readRDS(paste0(getwd(), "/maskRangeR/inst/extdata/expertMap.RDS"))
maskListRaw <- readRDS(paste0(getwd(), "/maskRangeR/inst/extdata/maskListRaw.RDS"))
maskBounds <- readRDS(paste0(getwd(), "/maskRangeR/inst/extdata/maskBounds.RDS"))
```
...
```{r, include = F}
variegatus <- readRDS(paste0(getwd(), "/maskRangeR/inst/extdata/variegatus.RDS"))
tridactylus <- readRDS(paste0(getwd(), "/maskRangeR/inst/extdata/tridactylus.RDS"))
torquatus <- readRDS(paste0(getwd(), "/maskRangeR/inst/extdata/torquatus.RDS"))
var_sdm <- readRDS(paste0(getwd(), "/maskRangeR/inst/extdata/var_sdm.RDS"))
tri_sdm <- readRDS(paste0(getwd(), "/maskRangeR/inst/extdata/tri_sdm.RDS"))
tor_sdm <- readRDS(paste0(getwd(), "/maskRangeR/inst/extdata/tor_sdm.RDS"))
# Crop tridactyus SDM to a 2-degree bounding box
ext_tri <- extent(c(min(tridactylus$longitude)-2, max(tridactylus$longitude)+2, min(tridactylus$latitude)-2, max(tridactylus$latitude)+2))
tri_sdm_mask <- mask(tri_sdm, as(ext_tri, "SpatialPolygons"))
...
```{r, include=F}
svmSP <- readRDS(paste0(getwd(), "/maskRangeR/inst/extdata/svmSP.RDS"))
sloth_svmSP <- readRDS(paste0(getwd(), "/maskRangeR/inst/extdata/sloth_svmSP.RDS"))
```
...
```{r, include=F}
svmHYB <- readRDS(paste0(getwd(), "/maskRangeR/inst/extdata/svmHYB.RDS"))
sloth_svmHYB <- readRDS(paste0(getwd(), "/maskRangeR/inst/extdata/sloth_svmHYB.RDS"))  
```
