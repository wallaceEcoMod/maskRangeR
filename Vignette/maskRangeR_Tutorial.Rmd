...
author: "Cory Merow, Peter J. Galante, Cecina Babich Morrow, Jamie M. Kass, Alex Moore, Valentina Grisales-Betancur, Jorge Velasquez, Beth Gerstner, Robert P. Anderson, Mary E. Blair"
date: "`r Sys.Date()`"
output:
...
To download example data used in this vignette, [click here](https://github.com/cmerow/maskRangeR/blob/master/demoData/demoData.zip?raw=true)
...
```{r, include=F}
path = "C:/Users/pgalante/Git/maskRangeR"
```
## Example
