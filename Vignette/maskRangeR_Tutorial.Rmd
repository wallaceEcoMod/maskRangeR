...
```{r}
## Set the pathway. You'll need to download the data from https://github.com/cmerow/maskRangeR and set your path to the appropriate location on your computer.
if(Sys.info()['user']=='ctg') path='../demoData'
if(Sys.info()['user']=='pgalante') path <- "path/to/your/data/directory"
```
