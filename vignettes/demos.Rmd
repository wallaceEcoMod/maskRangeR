...
spAnoB=maskRAid(potentialDist=spA,
                maskLayers=spB,
...
logicString='maskLayers>0.5'
spAnoB.t=maskRAid(potentialDist=spA.t,maskLayers=spB.t,logicString,method='mask')
...
spAnoB.t2=maskRAid(potentialDist=spA.t,maskLayers=spB.t,logicString,method='mask')
