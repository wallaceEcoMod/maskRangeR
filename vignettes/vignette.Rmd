...
author: "Cory Merow, Peter J. Galante, Cecina Babich Morrow, Jamie M. Kass, Alex Moore, Jorge Velasquez, Robert P. Anderson, Mary E. Blair"
date: "`r Sys.Date()`"
output:
...
library(maskRangeR)
library(lubridate)
dataDir = '/home/pgalante/Projects/NASA/maskrangeR/UseCaseData/useCases_shrink/dataDriven/olinguito/' # NOTE: Set this to where you have downloaded the data
```
...
library(raster)
library(rgdal)
dataDir = '/home/pgalante/Projects/NASA/maskrangeR/UseCaseData/useCases_shrink/dataDriven/Alouatta/'
```

Read in the original SDM and the expert polygon.
```{r}
original = stack('/home/pgalante/Projects/NASA/maskrangeR/UseCaseData/useCases_shrink/dataDriven/Alouatta/Alouatta_seniculus_0_mx.tif')
expertAddedPoly = rgdal::readOGR('/home/pgalante/Projects/NASA/maskrangeR/UseCaseData/useCases_shrink/dataDriven/Alouatta/Alouatta_seniculus_add_HO.shp')
```
...
[5] Jean-Francois Pekel, Andrew Cottam, Noel Gorelick, Alan S. Belward, High-resolution mapping of global surface water and its long-term changes. Nature 540, 418-422 (2016). (doi:10.1038/nature20584)_
...
library(raster)
library(rgdal)
dataDir = '/home/pgalante/Projects/NASA/maskrangeR/UseCaseData/useCases_shrink/expertDriven/swampForestCrab/'
```
...
```{r}
dataDir = '/home/pgalante/Projects/NASA/maskrangeR/UseCaseData/useCases_shrink/dataDriven/bradypus/'
...
country_list <- c("Honduras", "Nicaragua", "Costa Rica", "Panama", "Colombia", "Ecuador", "Peru", "Bolivia", "Chile", "Argentina", "Uruguay", "Paraguay", "Brazil", "French Guiana", "Suriname", "Guyana", "Venezuela")
...
```{r, message=FALSE}
# Create SVM
svmSP <- rangeSVM(variegatus[,2:3], tridactylus[,2:3], torquatus[,2:3], nrep = 10)
...
```{r, message = FALSE}
# Create SVM
svmHYB <- rangeSVM(variegatus[,2:3], tridactylus[,2:3], torquatus[,2:3], sdm = raster::stack(var_sdm, tri_sdm, tor_sdm), nrep = 10)

# Use SVM to create a raster of predicted regions
sloth_svmHYB <- rangeSVM_predict(svm = svmHYB, r = var_sdm, sdm = raster::stack(var_sdm, tri_sdm, tor_sdm))
```
